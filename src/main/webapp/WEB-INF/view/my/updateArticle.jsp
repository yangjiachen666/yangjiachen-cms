...
<body>
	<form id="form1">
		...
		<div class="form-group">
			...
			<textarea rows="10" id="centent" cols="30" name="content1" style="width: 825px;">
				${article.content }
			</textarea>
		</div>
		...
		<div class="form-group form-inline">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" class="btn btn-outline-success" value="发布" onclick="update()"/>
		</div>
	</form>
</body>
